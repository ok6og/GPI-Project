...
namespace Draw
{
	...
	public class TriangleShape : Shape
	{
		...
		public override void DrawSelf(Graphics grfx)
		{
			...
			Point b = new Point((int)Rectangle.X, (int)(Rectangle.Y + Rectangle.Height));
			Point c = new Point((int)(Rectangle.X + Rectangle.Width), (int)(Rectangle.Y + Rectangle.Height));
			Point[] points = { a, b, c };
			grfx.FillPolygon(new SolidBrush(Color.FromArgb(Opacity, FillColor)), points);
			grfx.DrawPolygon(new Pen(OutlineColor, OutlineWidth), points);
			grfx.ResetTransform();
